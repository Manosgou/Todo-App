        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            <DeleteTasks
              ...
              closeModal={() => this.onPresstoggleDeleteTasks()}
            />
          </Modal>
          <Modal
            animationType="slide"
          ...
          >
            <AddTask
              closeModal={() => this.onPresstoggleAddTaskModal()}
          ...
          <View style={styles.info}>
            ...
            <View style={styles.infoContainer}>
              ...
              >
                {this.state.tasks.length -
                  this.state.tasks.filter(function (s) {
                    return s.isFinished;
                  }).length}
              </Text>
            </View>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <Item
                  ...
                  onImportanceChange={this.onImportanceChange}
                  deleteTask={this.deleteTask}
                  finishTask={this.finishTask}
                  taskIsFinished={this.taskIsFinished}
                  title={item.title}
          ...
          <FloatActionButton
            buttonState={this.state.addTaskModal}
            onFABPress={() => this.onPresstoggleAddTaskModal()}
          />
        </SafeAreaView>
      );
    } else {
